...
use proj_epsg_format::{
    ...
    METHOD_AZIMUTHAL_EQUIDISTANT, METHOD_CASSINI_SOLDNER, METHOD_COLOMBIA_URBAN,
    METHOD_EQUAL_EARTH, METHOD_EQUIDISTANT_CYL, METHOD_GUAM, METHOD_HOTINE_OBLIQUE_MERCATOR_A,
